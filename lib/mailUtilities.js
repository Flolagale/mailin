...
//@TODO switch to https://github.com/humantech/node-spamd
...
module.exports = {
  ...
  computeSpamScore: function (parsedEmail, callback) {
    if (!isSpamcAvailable) {
      return callback(null, 0.0);
    }

    var sender    = parsedEmail.from[0].address;
    var receiver  = parsedEmail.todo[0].address;
    var subject   = parsedEmail.subject;
    var message   = parsedEmail.text;
