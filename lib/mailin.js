...
Mailin.prototype.start = function (callback) {
    var _this = this;
...
MailinReport.prototype.detectLanguage = function () {
    ...
    return new Promise(function (resolve) {
        if (_this.options.disableLanguageDetection || !_this.parseEmail) {
...
MailinReport.prototype.finalizeMessage = function () {
    ...
    return new Promise(function (resolve, reject) {
        ...
        parsedEmail.envelopeFrom = mimelib.parseAddresses(_this.connData.from);
        parsedEmail.envelopeTo = mimelib.parseAddresses(_this.connData.to);
